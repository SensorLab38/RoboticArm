...
Το τελικό πρόγραμμα που αναπτύσσεται παρακάτω θα κινεί τον βραχίονα έτσι, ώστε να συλλέγει φορτία από τρεις διαφορετικές τοποθεσίες και να τα αποθέτει επάνω στη ρομποτική πλατφόρμα. Το πρόγραμμα θα μας δίνει την δυνατότητα να επιλέγουμε πόσα φορτία να συλλέξει από κάθε τοποθεσία και πότε να σταματάει την συλλογή. Τα μέλη της ομάδας πέρα από το τελικό πρόγραμμα, θα κληθούν να με βάσει τις γνώσεις που απέκτησαν, να τροποποιήσουν το πρόγραμμα και να κινήσουν το βραχίονα με τον τρόπο που επιθυμούν. Τα προγράμματά τους θα παρατεθούν κάτω από το τελικό πρόγραμμα.     
