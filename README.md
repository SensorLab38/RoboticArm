...
Θα ακολουθήσει η μελετή για την τοπολογία των εξαρτημάτων και θα επιλέξουμε την καλύτερη δυνατή τοποθέτηση των αισθητήρων στην κατασκευή σε σχέση με τις καλοδιώσεις, έτσι ώστε η κίνηση του βραχίονα να μην εμποδίζεται σε καμμία από τις προγραμματισμένες κινήσεις του.   
...
Το Εργαστήριο Ρομποτικής SensorLab38 αποτελεί ένα χρήσιμο εργαλείο στα χέρια του εκπαιδευτικού και του μαθητή που τον βοηθάει να προγραμματίζει τους αισθητήρες και να δημιουργεί ηλεκτρονικά κικλώματα.
