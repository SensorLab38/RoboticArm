...
Για την καλύτερη οργάνωση και εκτέλεση του προγράμματος για την ολοκλήρωση του ρομποτικού βραχίονα η ομάδα χωρίστηκε σε πέντε υποομάδες όπου η κάθε ομάδα είχε συγκεκριμένα παθήκοντα. 
...
# Ομάδα βελτιώσεων 
Η ομάδα θα προτείνει πιθανές βελτιώσεις που μπορούν να γίνουν.
...
To stepper motor λειτουργεί διαφορετικά από τα άλλα μοτεράκια. Η κίνηση του ρότορα δεν γίνεται συνεχόμενα όπως π.χ. στο DC motor, αλλά με βήματα (steps). Από τα τεχνικά χαρακτηριστικά του stepper motor 28BYJ-48 που αναφέρουμε παραπάνω, για να πραγματοποιήσει ο άξονας του μια πλήρη περιστροφή, απαιτούνται 32 βήματα του ρότορα. Αυτό προκύπτει με βάση τους παρακάτω απλούς υπολογισμούς. 

Για κάθε οκτώ φάσεις των πηνίων του stepper motor, τα οποία ενεργοποιούνται από το Arduino, ο ρότορας διανύει ένα τόξο 11.25Ο μοίρες. Εάν διαιρέσουμε τις 360 μοίρες που έχει ο κύκλος με τις μοίρες του τόξου που διανύει ο ρότορας, έχουμε τον αριθμό των βημάτων που πραγματοποιεί το μοτέρ. Δηλαδή 32 βήματα (360 μοίρες/11.25 μοίρες = 32 steps). 

Στην πραγματικότητα το stepper motor με βάση μια διάταξη από γρανάζια στο εσωτερικό του, τα οποία μας δείνουν μια αναλογία 1 προς 64 (1/64), όπως αναφέρεται στις προδιαγραφές, για κάθε περιστροφή που βλέπουμε εμείς στον εξωτερικό άξονα, ο ρότορας στο εσωτερικό του  stepper motor πραγματοποιεί 64 περιστροφές. Γι'αυτό εάν θέλουμε να προγραμματίσουμε το stepper motor να κάνει μία πλήρη περιστροφή, θα πρέπει στην μεταβλητή μας να δόσουμε την τιμή 32 Χ 64 = 2048. Για δύο περιστροφές του αξονα θα δόσουμε την τιμή 4096, για μισή περιστροφή θα δόσουμε την τιμή 1024 κ.ο.κ. Με ευτόν τον τρόπο μπορούμε να προγραμματίσουμε το stepper motor έτσι ώστε, να μετακινήσουμε με μεγάλη ακρίβεια την όποια ρομποτική μας εφαρμογή.   
...
Ο ακροδέκτης του relay "C" ή "COM" είναι μόνιμα συνδεδεμένος με ένα ακροδέκτη του ηλεκτρομαγνήτη, ενώ ο ακροδέκτης "ΝΟ" είναι συνδεδεμένος με την πηγή ρεύματος 12 Volt. Για να κλείσει το κύκλωμα και να ενεργοποιειθεί ο ηλεκτρομαγνήτης πρέπει να συνδεθεί ο άλλος ακροδέκτης του ηλεκτρομαγνήτη με την πηγή.
