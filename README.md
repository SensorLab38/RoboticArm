...
Λίγα λόγια για το πως λειτουργeί το stepper motor.

To stepper motor λειτουργεί διαφορετικά από τα άλλα μοτεράκια. Η κίνηση του ρότορα δεν γίνεται συνεχόμενα όπως π.χ. στο DC motor, αλλά με βήματα (steps). Από τα τεχνικά χαρακτηριστικά του stepper motor 28BYJ-48 που αναφέρουμε παραπάνω, για να πραγματοποιήση μια πλήρη περιστροφή, απαιτούνται 32 βήματα. Αυτό προκύπτει με βάση τους παρακάτω απλούς υπολογισμούς. 
...
Στην πραγματικότητα το stepper motor με βάση μια διάταξη από γρανάζια στο εσωτερικό του, τα οποία μας δείνουν μια αναλογία 1 προς 64 (1/64), όπως αναφέρεται στις προδιαγραφές, για κάθε περιστροφή που βλέπουμε εμείς στον εξωτερικό άξονα, το stepper motor στο εσωτερικό του πραγματοποιεί 64 περιστροφές. Γι'αυτό εάν θέλουμε να προγραμματίσουμε το stepper motor να κάνει μία περιστροφή, θα πρέπει στην μεταβλητή μας να δόσουμε την τιμή: 32 steps Χ 64 περιστροφές του ρότορα εκτός = 2048 περιστροφές του ρότορα εντός. Για δύο περιστροφές θα δόσουμε την τιμή 4096, για μισή περιστροφή θα δόσουμε την τιμή 1024 κ.ο.κ. Με ευτόν τον τρόπο μπορούμε να μετακινήσουμε με μεγάλη ακρίβεια την ρομποτική μας εφαρμογή.   


# Ο Ηλεκτρομαγνήτης

Μελετήσαμε τη λειτουργία, τη συνδεσμολογία και τον προγραμματισμό του ηλεκτρομαγνήτη. Στο πατακάτω σχήμα βλέπουμε πως συνδέονται μεταξύ τους το Relay με το Arduino και με τoν ηλεκτρομαγνήτης.  
...
Πρέπει να παρατηρήσουμε εδώ ότι στην συνδεσμολογία έχουμε δύο ξεχωριστά κυκλώματα με δύο διαφορετικές πηγές ρεύματος. Το ένα κύκλωμα αποτελείται από το Arduino με το Relay, και το άλλο με το relay και τον ηλεκτρομαγνήτη.  
