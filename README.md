...
Τα μέλη της ομάδας είναι:
 ...
 Θάνος Αγγελόπουλος, Μιχάλης Αγαπάκης, Σπύρος Γιαννακούρας, Φίλιππος Ευσταθιάδης, Παναγιώτης Κουτρωτσιος, Θανάσης Ντενίσης, Γρηγόρης    Μακρόπουλος, Δημήτρης Μπεκιάρης, Αντώνης Πυροβολάκης, Τάγκαλης Ανδρέας.
 

Η πρώτη φάση της εκπαίδευσης.

Η πρώτη φάση της εκπαίδευσης έχει ολοκληρωθεί. 
Οι μαθητές εκπαιδεύτηκαν στις βασικές έννοιες του προγραμματισμού με τις γλώσσες προγραμματισμού Scratch, Scratch for Arduino S4A και   IDE programming language του Arduino. 
Με την βοήθεια του Eργαστηρίου Rομποτικής (SensorLab38) έμαθαν να προγραμματίζουν τους αισθητήρες και να αναβοσβήνουν τα λαμπάκια led και RGB led, μοτεράκια όπως μπορούμε να δούμε ενδεικτικά στο παρακάτω σχήμα:
...
Στην συνέχεια η ομάδα επέλεξε το υλικό κατασκευής από ανθεκτικό ξύλο "Σημύδα" από δένδρο που φύεται στην Σιβηρία.

Για την λειτουργία του έχει επιλεγεί ο μικροκοντρόλερ Arduino UNO, δύο Stepper motors, ένας ηλεκτρομαγνήτης, ένα relay, Led, αντιστάσεις, καλώδια, βίδες και άλλα βοηθητικά υλικά.
...
Στην συνέχεια η ομάδα μελέτησε ένα προς ένα όλους αισθητήρες με πρώτο το stepper motor 28BYJ-48, καθώς και το stepper motor drive (ULN2003A).
