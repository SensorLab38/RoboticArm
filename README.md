...
Το τελικό πρόγραμμα που αναπτύσσεται παρακάτω θα κινεί τον βραχίονα έτσι, ώστε να συλλέγει φορτία από τρεις διαφορετικές τοποθεσίες και να τα αποθέτει επάνω στη ρομποτική πλατφόρμα. Το πρόγραμμα θα δίνει την δυνατότητα να επιλέγουμε πόσα φορτία να συλλέξει από κάθε τοποθεσία και και να σταματάει την συλλογή με προγραμματισμένες κινήσεις. Τα μέλη της ομάδας πέρα από το τελικό πρόγραμμα, θα κληθούν να με βάσει τις γνώσεις τους να τροποποιήσουν το πρόγραμμα και κινήσουν το βραχίωνα με τον τρόπο που επιθυμούν. Τα προγραμματά τους θα παρατεθούν κάτω από το τελικό πρόγραμμα.     
