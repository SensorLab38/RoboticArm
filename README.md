...
Από την αρχή που συστάθηκε η ομάδα, οργανώσαμε το πρόγραμμα των μαθημάτων με κύριο στόχο όλοι οι μαθητές να έχουν κατανοήσει τις βασικές έννοιες του προγραμματισμού. Ξεκινήσαμε με την γλώσσα Scratch 2.0, προχωρήσαμε με την scratch for Arduino (S4A) και στην συνέχεια περάσαμε στην Arduino IDE (C++) με την οποία προγραμματίσαμε το ρομποτικό βραχίονα. Αυτή η προσέγγιση θεωρούμε ότι βοήθησε την ομάδα να κατανοήσει και να εμπεδόσει καλύτερα την διαδικασία δημιουρίας μας ρομποτικής εφαρμογής.

Η ομάδα των δέκα μαθητών της τετάρτης δημοτικού διδάχτηκε συνολικά τα παρακάτω γνωστικά πεδία.
Τις βασικές έννοιες προγραμματισμού.
Την μελέτη και τον σχεδίαση ρομποτικού μηχανισμού.
Εξασκίθηκε σε βασικές δεξιότητες συναρμολόγησης ρομποτικού βραχίονα.
Την γνωριμία και την χρήση για μια σειρά από αισθητήρες.
Τις βασικές γνώσεις ηλεκτρικών και ηλεκτρονικών κυκλωμάτων.
Δόθηκε εμφαση στον τελικός στόχος της κατασκευής και αυτό βοήθησε την ομάδα να μείνει εστιασμένη στο στόχο της.   
Εργάστηκε ομαδικά και γνώρισε την εμπειρία της συλλογικής προσπάθεια.
Γνώρισε την αξία του ματαμερισμού εργασίας με την δημιουργία υποομάδων με συγκεκριμένα καθήκοντα.
Ξετυλίκτηκε η ατομική και συλλογική δημιουργική σκέψη και φάνηκσν ψείγματα καινοτιμίας, με νέες προτάσεις βελτίωσης του ρομποτικού.
Παρατηρήθηκε ατομική αυτενέργεια όταν παρουσιάστηκαν διαφορετικές προσεγγίσεις στην πορεία της κατασκεής από μαθητές 
Αναπτύχθηκε αυθόρμητη ευγενική άμιλα ανάμεσα στα μέλη της ομάδας η οποία έδοσε ώθηση για περισότερη γνώσης.   
Ο ενθουσιασμός ήταν διάχυτος και η προσμονή για το τελικό αποτέλεσμα βοήθησε να εμπεδοθούν τα ενδιάμεσα στάδια. 

Τέλος όλη η ομάδα ατομικά και συλλογικά ένοιωσε την χαρά της δημιουργίας μια ρομποτικής εφαρμογής την οποία η ίδια δημιούργησε, όταν μια αρχική ιδέα μελετήθηκε, σχεδιάστηκε, συναρμολογήθηκε, προγραμματίστηκε και όλοκληρώθηκε. 
Πρόσπάθεια έγινε να ενθαρύνθει το κίνητρο της φιλομάθειας, της αυτενέργειας, της δημιουργικότητας και της καινοτόμου σκέψης, απαιρέτητες αξίες για την ολόπλευρη ανάπτυξη της προσωπικότητας του μαθητή και για την κοινωνική και επαγγελματική πορεία του στην ζωή.  
